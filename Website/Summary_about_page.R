...
Aboutinfo_page <- tabPanel(
    ...
    wellPanel(
        ...
        p("For further details about the methods and analysis behind this study, please see our paper:" ,a("Duffy, Á. et al. Development of a human genetics-guided priority score for 19,365 genes and 399 drug indications. Nat Genet (2024)", href="https://www.nature.com/articles/s41588-023-01609-2"),'.')
    ),
